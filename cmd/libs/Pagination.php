...
class Pagination {
  ...
  private $first_link = '', $last_link = '', $prev_link = '', $next_link = '',
          ...
          $first_tag_open = '<li class="ff icon-ll">', $first_tag_close = '</li>',
          $prev_tag_open = '<li class="pp icon-l">', $prev_tag_close = '</li>',
          $num_tag_open = '<li>', $num_tag_close = '</li>',
          $cur_tag_open = '<li class="active"><a href="#">', $cur_tag_close = '</a></li>',
          $next_tag_open = '<li class="nn icon-r">', $next_tag_close = '</li>',
          $last_tag_open = '<li class="ll icon-rr">', $last_tag_close = '</li>';
